...
async def upload_note(file: UploadFile = File(...)):
    ...
    try:
        ...
        system_message = {
            "role": "system",
            "content": f"You are a helpful medical educator agent. You will generate short and easy to understand chat. Here is the discharge not of the patient. \nDischarge Note : \n{discharge_note}"
        }

        # Reset messages
        messages = [system_message]
        
        # test whether discharge note is uploaded successfully
        print(messages)
